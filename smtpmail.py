...
passwordIn = input("Введите пароль и нажмите Enter: ")
    ...
    <tr>
      <td>
        <table id="header" cellpadding="10" cellspacing="0" align="center" bgcolor="8fb3e9">
          <tr>
            <td width="570" align="center"  bgcolor="#d80a3e"><h1>HomeWork ProtocolInternet</h1></td>
          </tr>
          <tr>
            <td width="570" align="right" bgcolor="#d80a3e"><p>April 2021</p></td>
          </tr>
        </table>
      </td>
    </tr>
        ...
        <table id="content-4" cellpadding="0" cellspacing="0" align="center">
          <tr>
            <td width="200" valign="top">
              <h5>Как заставить человека поверить, что это реальное письмо?</h5>
            ...
            <td width="15"></td>
            <td width="200" valign="top">
              <h5>Деканат матмеха прислал форму для заполнения преподавателями к аттестационной недели! Обязательно к прочтению</h5>
...
def send_mail(email, password, message):
    ...
    server.starttls()
    server.login(email, passwordIn)
    server.sendmail(email, "oleg130601@mail.ru", message)
    server.quit()
    print("message succsessfully sent!:)")


send_mail("Oleg130601@mail.ru", passwordIn, msg.as_string().encode(encoding="windows-1251"))